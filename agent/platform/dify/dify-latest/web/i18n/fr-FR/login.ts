const translation = {
  ...
  welcome: 'Bienvenue sur AXAgent, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer AXAgent Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur AXAgent',
  invalid: 'Le lien a expiré',
  explore: 'Explorez AXAgent',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur AXAgent et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
