const translation = {
  ...
  intro1: 'O Conhecimento pode ser integrado ao aplicativo AXAgent ',
  ...
  externalAPIPanelDescription: 'A API de conhecimento externo é usada para se conectar a uma base de conhecimento fora do AXAgent e recuperar o conhecimento dessa base de conhecimento.',
