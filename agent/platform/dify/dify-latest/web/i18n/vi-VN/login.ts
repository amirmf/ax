const translation = {
  ...
  welcome: 'Chào mừng bạn đến với AXAgent, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của AXAgent, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại AXAgent',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá AXAgent',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên AXAgent và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
