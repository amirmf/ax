const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account AXAgent',
    langGeniusAccountTip: 'Il tuo account AXAgent e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a AXAgent per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da AXAgent ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di AXAgent.',
  ...
  about: {
    ...
    nowAvailable: 'AXAgent {{version}} è ora disponibile.',
    latestAvailable: 'AXAgent {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
