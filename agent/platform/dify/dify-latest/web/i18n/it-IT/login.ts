const translation = {
  ...
  welcome: 'Benvenuto su AXAgent, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare AXAgent Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su AXAgent',
  invalid: 'Il link è scaduto',
  explore: 'Esplora AXAgent',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su AXAgent e ti invieremo un\'e-mail per reimpostare la password.',
