const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a AXAgent cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a AXAgent.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome AXAgent Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
