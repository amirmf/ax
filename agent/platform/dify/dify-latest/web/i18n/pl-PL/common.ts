const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto AXAgent',
    langGeniusAccountTip: 'Twoje konto AXAgent i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do AXAgent, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez AXAgent pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach AXAgent.',
  ...
  about: {
    ...
    nowAvailable: 'AXAgent {{version}} jest teraz dostępny.',
    latestAvailable: 'AXAgent {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
