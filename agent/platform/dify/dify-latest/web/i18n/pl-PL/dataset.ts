const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją AXAgent ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza AXAgent i pobierania wiedzy z tej bazy wiedzy.',
}
