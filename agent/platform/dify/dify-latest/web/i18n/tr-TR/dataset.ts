const translation = {
  ...
  intro1: 'Bilgi, AXAgent uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, AXAgent dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
