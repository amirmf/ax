const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AXAgent hesabı',
    langGeniusAccountTip: 'AXAgent hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, AXAgent\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'AXAgent tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, AXAgent\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: 'AXAgent {{version}} şimdi mevcut.',
    latestAvailable: 'AXAgent {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
