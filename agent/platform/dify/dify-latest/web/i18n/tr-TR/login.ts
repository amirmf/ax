const translation = {
  ...
  welcome: 'AXAgent\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'AXAgent Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'AXAgent\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
