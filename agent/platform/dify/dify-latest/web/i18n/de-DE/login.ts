const translation = {
  ...
  welcome: 'Willkommen bei AXAgent, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AXAgent Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AXAgent beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AXAgent erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei AXAgent angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
