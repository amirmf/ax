const translation = {
  ...
  welcome: '👋 Welcome to AXAgent, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting AXAgent Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on AXAgent',
  invalid: 'The link has expired',
  explore: 'Explore AXAgent',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on AXAgent and we will send you a password reset email.',
