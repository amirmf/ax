const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AXAgent account',
    langGeniusAccountTip: 'Your AXAgent account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to AXAgent to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AXAgent allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across AXAgent\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'AXAgent {{version}} is now available.',
    latestAvailable: 'AXAgent {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
