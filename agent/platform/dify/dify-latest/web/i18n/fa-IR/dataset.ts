const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه AXAgent ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از AXAgent و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
