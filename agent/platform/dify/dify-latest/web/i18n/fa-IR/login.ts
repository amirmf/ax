const translation = {
  ...
  welcome: 'به AXAgent خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع AXAgent Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در AXAgent',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش AXAgent',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در AXAgent استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
}
