          ...
          <a
            ...
            href={
              locale === LanguagesSupported[1]
                ? 'https://docs.axagent.automatx.ir/v/zh-hans/guides/knowledge-base/integrate_knowledge_within_application'
                : 'https://docs.axagent.automatx.ir/guides/knowledge-base/integrate-knowledge-within-application'
            }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - AXAgent`
  }, [datasetRes])
  ...
  return (
    <div className='grow flex overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.axagent.automatx.ir/images/dataset-default-icon.png'}
