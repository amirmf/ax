      ...
      <div className='relative pt-4'>
        ...
        <div>
          ...
          <div className='mb-4 text-center text-xs font-normal text-gray-700'>
            <div>© {dayjs().year()} AutomatX.ai, Inc., Contributors.</div>
            <div className='text-[#1C64F2]'>
              {
                 <>
                    <Link href='https://axagent.automatx.ir/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,<span> </span>
                    <Link href='https://axagent.automatx.ir/terms' target='_blank' rel='noopener noreferrer'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center'>
            <Link
              ...
              href={'https://github.com/axagent/releases'}
