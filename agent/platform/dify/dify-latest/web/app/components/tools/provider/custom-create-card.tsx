...
const Contribute = ({ onRefreshData }: Props) => {
  ...
  const linkUrl = useMemo(() => {
    if (language.startsWith('zh_'))
      return 'https://docs.axagent.automatx.ir/v/zh-hans/guides/gong-ju/quick-tool-integration'
    return 'https://docs.axagent.automatx.ir/tutorials/quick-tool-integration'
  }, [language])
