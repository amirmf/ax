...
export default function App() {
  ...
  const [loadingText, setLoadingText] = useState("Initializing AXAgentPro");
  ...
  useEffect(() => {
    handleMarketplace()
    loadingTextEffect('Initializing AXAgentPro', setLoadingText, 500);
  ...
  useEffect(() => {
    if (selectedProject !== null) {
      ...
      if (source === 'models.AXAgentPro')
        window.open('https://models.AXAgentPro.com/', '_self');
      else
    ...
    <div className="app">
      ...
      {applicationState === 'AUTHENTICATED' && !showMarketplace ? (<div className="projectStyle">
        ...
        <div className="signInTopBar">
          <div className="AXAgentProLogo"><Image width={132} height={72} src="/images/sign-in-logo.svg"
        ...
        <div className="signInCenter">
          {applicationState === 'NOT_AUTHENTICATED' && !showMarketplace ? <div className="signInWrapper">
            ...
            <div className="signInInfo">
              By continuing, you agree to AXAgentPro’s Terms of Service and Privacy Policy, and to receive important
              updates.
            </div>
