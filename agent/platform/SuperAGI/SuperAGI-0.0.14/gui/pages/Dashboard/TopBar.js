...
export default function TopBar({selectedProject, userName, env}) {
  ...
  function handleClick (option) {
    if (option === 'Models') {
      ...
      window.location.href = 'https://models.AXAgentPro.com'
    } else {
    ...
    <div className="top_bar">
      ...
      <div className="top_right">
        <div className="horizontal_container gap_20">
          <div className="horizontal_container w_fit_content cursor_pointer gap_4" onClick={() => {window.open("https://AXAgentPro.com/docs", "_blank");}}>
